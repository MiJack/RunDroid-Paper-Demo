...
public class AppThemeListPreference extends ListPreference {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        com.mijack.Xlog.logMethodEnter("void com.haringeymobile.ukweather.settings.AppThemeListPreference.onPrepareDialogBuilder(AlertDialog.Builder)",this,builder);try{int index = findIndexOfValue(getSharedPreferences().getString(getKey(),
        ...
        super.onPrepareDialogBuilder(builder);com.mijack.Xlog.logMethodExit("void com.haringeymobile.ukweather.settings.AppThemeListPreference.onPrepareDialogBuilder(AlertDialog.Builder)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.haringeymobile.ukweather.settings.AppThemeListPreference.onPrepareDialogBuilder(AlertDialog.Builder)",this,throwable);throw throwable;}
    }
