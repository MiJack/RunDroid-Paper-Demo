...
public class WidgetUpdateTask extends AsyncTask<Void, Void, Void> {
    ...
    public Void doInBackground(Void... params) {
        com.mijack.Xlog.logMethodEnter("java.lang.Void com.chanapps.four.widget.WidgetUpdateTask.doInBackground([java.lang.Void)",this,params);try{if (DEBUG) {Log.i(TAG, "doInBackground() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/");}
        loadBoard();
        ...
        {com.mijack.Xlog.logMethodExit("java.lang.Void com.chanapps.four.widget.WidgetUpdateTask.doInBackground([java.lang.Void)",this);return null;}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("java.lang.Void com.chanapps.four.widget.WidgetUpdateTask.doInBackground([java.lang.Void)",this,throwable);throw throwable;}
    }

    @Override
    public void onPostExecute(Void result) {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.onPostExecute(java.lang.Void)",this,result);try{if (DEBUG) {Log.i(TAG, "onPostExecute() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ type=" + widgetConf.widgetType);}com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.onPostExecute(java.lang.Void)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.onPostExecute(java.lang.Void)",this,throwable);throw throwable;}
    }

    private void updateWideWidget() {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateWideWidget()",this);try{if (DEBUG) {Log.i(TAG, "updateWideWidget() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ type=" + widgetConf.widgetType);}
        ...
        updateImages(BoardWidgetProvider.MAX_THREADS, 0, R.layout.widget_board_layout, imageIds);com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateWideWidget()",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateWideWidget()",this,throwable);throw throwable;}
    }

    private void updateOneImageWidget() {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateOneImageWidget()",this);try{if (DEBUG) {Log.i(TAG, "updateOneImageWidget() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ type=" + widgetConf.widgetType);}
        ...
        updateImages(BoardOneImageWidgetProvider.MAX_THREADS, 0, R.layout.widget_board_oneimage_layout, imageIds);com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateOneImageWidget()",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateOneImageWidget()",this,throwable);throw throwable;}
    }

    private void updateCoverFlowWidget() {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowWidget()",this);try{if (DEBUG) {Log.i(TAG, "updateCoverFlowWidget() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ type=" + widgetConf.widgetType);}
        ...
        }com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowWidget()",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowWidget()",this,throwable);throw throwable;}
    }

    private void updateCoverFlowCardWidget() {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowCardWidget()",this);try{if (DEBUG) {Log.i(TAG, "updateCoverFlowCardWidget() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ type=" + widgetConf.widgetType);}
        ...
        AppWidgetManager.getInstance(context).notifyAppWidgetViewDataChanged(widgetConf.appWidgetId, R.id.stack_view_coverflow);
        int maxThreads = NetworkProfileManager.instance().getCurrentProfile().getFetchParams().maxThumbnailPrefetches;
        updateImages(maxThreads, R.id.stack_view_coverflow, 0, null);com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowCardWidget()",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateCoverFlowCardWidget()",this,throwable);throw throwable;}
    }
    
    private void loadBoard() {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.loadBoard()",this);try{try {
        ...
        }com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.loadBoard()",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.loadBoard()",this,throwable);throw throwable;}
    }

    private void bindClickTargets(int widgetContainer, RemoteViews views, boolean boardCodeOnly) {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.bindClickTargets(int,android.widget.RemoteViews,boolean)",this,widgetContainer,views,boardCodeOnly);try{if (DEBUG) {Log.i(TAG, "bindClickTargets() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/");}
        ...
        if (board == null) {
            Log.e(TAG, "bindClickTargets() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/"
                    + " null board, exiting");
            {com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.bindClickTargets(int,android.widget.RemoteViews,boolean)",this);return;}
        }
        ...
        if (DEBUG) {Log.i(TAG, "bindClickTargets() id=" + widgetConf.appWidgetId + " /" + widgetConf.boardCode + "/ finished");}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.bindClickTargets(int,android.widget.RemoteViews,boolean)",this,throwable);throw throwable;}
    }

    private PendingIntent makeThreadIntent(ChanPost thread, int i) {
        com.mijack.Xlog.logMethodEnter("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeThreadIntent(com.chanapps.four.data.ChanPost,int)",this,thread,i);try{Intent intent = (thread == null || thread.no < 1)
        ...
        {com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeThreadIntent(com.chanapps.four.data.ChanPost,int)",this);return PendingIntent.getActivity(context, uniqueId, intent, PendingIntent.FLAG_UPDATE_CURRENT);}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeThreadIntent(com.chanapps.four.data.ChanPost,int)",this,throwable);throw throwable;}
    }

    private PendingIntent makeBoardIntent() {
        com.mijack.Xlog.logMethodEnter("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeBoardIntent()",this);try{Intent intent = BoardActivity.createIntent(context, widgetConf.boardCode, "");
        intent.putExtra(ActivityDispatcher.IGNORE_DISPATCH, true);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
        int uniqueId = (100 * widgetConf.appWidgetId) + 2;
        {com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeBoardIntent()",this);return PendingIntent.getActivity(context, uniqueId, intent, PendingIntent.FLAG_UPDATE_CURRENT);}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeBoardIntent()",this,throwable);throw throwable;}
    }

    private PendingIntent makeRefreshIntent() {
        com.mijack.Xlog.logMethodEnter("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeRefreshIntent()",this);try{Intent intent;
        if (ChanBoard.WATCHLIST_BOARD_CODE.equals(widgetConf.boardCode)) {
            {com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeRefreshIntent()",this);return null;}
        ...
        {com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeRefreshIntent()",this);return PendingIntent.getService(context, uniqueId, intent, PendingIntent.FLAG_UPDATE_CURRENT);}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeRefreshIntent()",this,throwable);throw throwable;}
    }

    private PendingIntent makeConfigureIntent() {
        com.mijack.Xlog.logMethodEnter("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeConfigureIntent()",this);try{Intent intent;
        if (WidgetConstants.WIDGET_TYPE_ONE_IMAGE.equalsIgnoreCase(widgetConf.widgetType))
            ...
            {{com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeConfigureIntent()",this);return null;}}
        intent.putExtra(AppWidgetManager.EXTRA_APPWIDGET_ID, widgetConf.appWidgetId);
        intent.putExtra(ActivityDispatcher.IGNORE_DISPATCH, true);
        int uniqueId = (100 * widgetConf.appWidgetId) + 4;
        {com.mijack.Xlog.logMethodExit("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeConfigureIntent()",this);return PendingIntent.getActivity(context, uniqueId, intent, PendingIntent.FLAG_UPDATE_CURRENT);}}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("android.app.PendingIntent com.chanapps.four.widget.WidgetUpdateTask.makeConfigureIntent()",this,throwable);throw throwable;}
    }

    private void updateImages(final int maxThreads, final int containerId, final int layoutId, final int[] imageIds) {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateImages(int,int,int,[int)",this,maxThreads,containerId,layoutId,imageIds);try{final List<String> preloadURLs = WidgetProviderUtils.preloadThumbnailURLs(context, widgetConf.boardCode, maxThreads);
        if (preloadURLs == null) {
            ...
            {com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateImages(int,int,int,[int)",this);return;}
        }
        ...
        updateWidget(containerId, layoutId, imageIds);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateImages(int,int,int,[int)",this,throwable);throw throwable;}
    }

    private void updateWidget(int containerId, int layoutId, int[] imageIds) {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateWidget(int,int,[int)",this,containerId,layoutId,imageIds);try{if (containerId > 0) {
        ...
        }com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateWidget(int,int,[int)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateWidget(int,int,[int)",this,throwable);throw throwable;}
    }

    private void updateAppWidgetImages(final int layoutId, final int[] imageIds) {
        com.mijack.Xlog.logMethodEnter("void com.chanapps.four.widget.WidgetUpdateTask.updateAppWidgetImages(int,[int)",this,layoutId,imageIds);try{RemoteViews views = new RemoteViews(context.getPackageName(), layoutId);
        ...
        AppWidgetManager.getInstance(context).updateAppWidget(widgetConf.appWidgetId, views);com.mijack.Xlog.logMethodExit("void com.chanapps.four.widget.WidgetUpdateTask.updateAppWidgetImages(int,[int)",this);}catch(Throwable throwable){com.mijack.Xlog.logMethodExitWithThrowable("void com.chanapps.four.widget.WidgetUpdateTask.updateAppWidgetImages(int,[int)",this,throwable);throw throwable;}
    }
